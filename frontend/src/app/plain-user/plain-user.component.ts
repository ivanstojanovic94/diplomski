...
export class PlainUserComponent implements OnInit {
  ...
  initColumns = [{ name: 'name', display: 'Naziv' },
  { name: 'scienceField', display: 'Naučno polje' },
  { name: 'institution', display: 'Institucija' },
  { name: 'publishDate', display: 'Datum objave' },
  { name: 'deadline', display: 'Rok prijave' }];
